...
<body>
														...
														<div class="form-group">
															<select class="custom-select" name=role>
																...
																<%
																	...
																	String squl = "SELECT * FROM role";
																	PreparedStatement psmt = conn.prepareStatement(squl);
																	ResultSet rs1 = psmt.executeQuery();
																	while (rs1.next()) {
																%>
																<option value="--------Select--------"></option>
																<option value="<%=rs1.getLong(1)%>"><%=rs1.getString(2)%></option>
 ...
 --%>
											...
											<%-- 	<div class="col-md-12">
													<label for="form_message">Email:</label> <input

...
<nav class="navbar bg-light">
		<span class="navbar-brand mb-0 h1"
			style="color: teal;">Crime-Report<a style="margin-left: 1270px;"><%=welcomeMsg%></a>
		</span>
	</nav>
...
<%-- 
				...
				<li class="nav-item active"><a class="nav-link" href="<%=OCRView.ABOUT_CTL %>">About</a></li>
				...
				<div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
					<ul class="navbar-nav">
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="#"
							id="navbarDarkDropdownMenuLink" role="button"
							data-bs-toggle="dropdown" aria-expanded="false">FIR</a>
							<ul class="dropdown-menu dropdown-menu-dark"
								aria-labelledby="navbarDarkDropdownMenuLink">
								<li><a class="dropdown-item" href="<%=OCRView.FIR_CTL %>">Write FIR</a></li>
								<li><a class="dropdown-item" href="<%=OCRView.FIR_LIST_CTL%>">Show FIR</a></li>
							</ul></li>
					</ul>
				</div>
...
<%-- 				<li class="nav-item active"><a class="nav-link" href="<%=OCRView.ROLE_CTL%>">ADD Role</a></li>
 --%>
				...
				<li class="nav-item active"><a class="nav-link" href="<%=OCRView.CONTACT_CTL %>">Contact
						Us</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="<%=OCRView.ABOUT_CTL %>">About</a></li>
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
            <li><a class="dropdown-item" href="<%=NPView.POLITICAL_CTL%>">Political  Blog</a></li>
            <li><a class="dropdown-item" href="<%=NPView.SPORTS_CTL%>">Sport Blog</a></li>
          </ul>
        </li>
      </ul>
    </div> --%>
				...
				<li class="nav-item"><a class="nav-link" href="<%=OCRView.CONTACT_CTL %>">Contact</a></li>
				...
				<div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
					<ul class="navbar-nav">
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu dropdown-menu-dark"
								aria-labelledby="navbarDarkDropdownMenuLink">
								<li><a class="dropdown-item" href="<%=OCRView.LOGIN_CTL%>">SingIn</a></li>
								<li><a class="dropdown-item"
									href="<%=OCRView.USER_REGISTRATION_CTL%>">SingUp</a></li>
							</ul></li>
					</ul>
				</div>
			</ul>

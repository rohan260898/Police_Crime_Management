...
<body>
	...
	%>
	<h2 align="center" style="color: Teal">Criminal List</h2>
	<br>
	...
	<form action="<%=OCRView.CRIMINAL_LIST_CTL%>" method="post">
		...
		<table width="100%">
			<tr>
				<td align="center"><label>Name :</label> <input type="text"
					...
					class="btn btn-info" value="<%=CriminalListCtl.OP_SEARCH%>">&emsp;
					<input type="submit" name="operation" class="btn btn-primary"
					value="<%=CriminalListCtl.OP_RESET%>">
			</tr>
		</table>
		<br>

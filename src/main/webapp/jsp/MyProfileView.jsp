...
<body>
	...
	<div class="container">
		...
		<h2 align="center" style="background-color: aqua;;">MyProfile</h2>
		...
		<form action="<%=OCRView.MYPROFILE_CTL%>" method="post">
			...
			<div class="row">
				<div class="col-2"></div>
				<div class="col-8" style="background-color: maroon;">
 ...
 --%>
                  ...
                  <%--   <%
					...
					<div class="mb-3">
						...
						<%=HTMLUtility.getList("roleName", String.valueOf(bean.getRoleName()), map)%>
